...
# Datasets
parser.add_argument('-d', '--dataset', default='fmnist', type=str)
...
# Validate dataset
assert args.dataset == 'cifar10' or args.dataset == 'cifar100' or args.dataset =='svhn' or args.dataset == 'fmnist', 'Dataset can only be cifar10, cifar100 or fmnist.'
...
def main():
    ...
    if args.evaluate:
        ...
        # Calculate the dictionary matrix for the top-2.
...
def test(testloader, model, criterion, epoch, use_cuda):
    ...
    # switch to evaluate modemodel_best.pth.tar
    #ck = torch.load("./checkpoint/model_best.pth.tar")
